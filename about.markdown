...
Connect on [LinkedIn](https://www.linkedin.com/in/{{ site.linkedin_username | strip }}/){:target="_blank" rel="noopener noreferrer"}. Explore my research on [Google Scholar](https://scholar.google.com/citations?user=xc84WNMAAAAJ&hl=en){:target="_blank" rel="noopener noreferrer"}.

...
<div style="margin: 32px 0; border: 1px solid #e0ddd4; border-radius: 4px; overflow: hidden;">
  <iframe
    src="/assets/regen-data-viz.html"
    width="100%"
    height="3600"
    frameborder="0"
    style="display:block;"
    title="Regenerative agriculture landscape data visualizations">
  </iframe>
</div>
...
<div style="margin: 32px 0; border: 1px solid #e0ddd4; border-radius: 4px; overflow: hidden;">
  <iframe
    src="/assets/regen-ecosystem-map.html"
    width="100%"
    height="560"
    frameborder="0"
    style="display:block;"
    title="Regenerative Agriculture Ecosystem Map">
  </iframe>
</div>
<p style="font-size: 13px; color: #888; margin-top: -16px;">
...
This project is designed to evolve in that direction. The landscape database is the foundation. The network is the next layer. [Continue to Part 2: What the Connections Reveal →](/network-map-case-study-part-2/)

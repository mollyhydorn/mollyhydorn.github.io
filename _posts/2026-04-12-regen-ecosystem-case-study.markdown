...
*Brand certification reflects a contested definition.* ROC accounts for 61% of brand certifications, followed by Rainforest Alliance (20%) and Regenified (17%). These are philosophically distinct standards with different verification requirements. Their co-presence under the "regenerative" label reflects an ecosystem still negotiating what the term demands, and a brand landscape that may be ahead of the supply chain infrastructure needed to back its claims.
...
This project is designed to evolve in that direction. The landscape database is the foundation. The network is the next layer.
